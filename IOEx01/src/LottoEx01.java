...
public class LottoEx01 {
	...
	public static void main(String[] args) {
		...
		try {
			br = new BufferedReader(new FileReader("C:\\Java\\java_workspace\\KIC_JAVASTUDY_ecilpse\\IoEx01\\lotto(1~1059).csv"));
			bw = new BufferedWriter(new FileWriter("C:\\Java\\java_workspace\\KIC_JAVASTUDY_ecilpse\\IoEx01\\/lottostatistics.txt"));
