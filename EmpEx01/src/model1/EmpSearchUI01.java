	...
	public EmpSearchUI01() {
		...
		btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String strEmp = textField.getText().trim();
				if(strEmp.length()< 2) {
					JOptionPane.showMessageDialog(EmpSearchUI01.this,"사원이름을 두자이상으로 입력하세요","입력경고",JOptionPane.WARNING_MESSAGE);
				}else {
					list.setModel(new EmpListModel(strEmp));
				}
			}
		});
